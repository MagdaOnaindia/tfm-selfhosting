...
# 2.2b --- Copiar certificados a /opt/selfhosting/certs ---
log_info "Copiando certificados a /opt/selfhosting/certs..."
sudo cp "${PROJECT_ROOT}/certs/agent.pfx" /opt/selfhosting/certs/
sudo cp "${PROJECT_ROOT}/certs/ca.crt" /opt/selfhosting/certs/
...
AGENT_CERT_PASSWORD=${AGENT_PASS}
EOF
